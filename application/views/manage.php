                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="<?=site_url('space/view')?>">用户管理</a></li>
...
<!--                            <i class="i-work-sex-30---><?php //if($user['sex']==='男')echo 1;else echo 0;?><!-- posa avatar-sex"></i>-->
            ...
            <div class="row" style="padding: 0 5px 0 10px;">
                <div class="col-xs-3" style="float: right;padding: 0 5px;">
                    <a class="_btn _btn--white _btn--l _btn--block mb30" href="<?=site_url('admin/logout')?>">
                        <span class="text">退出管理系统</span>
                    </a>
                </div>
                <div class="col-xs-9">
                    <div id="l-space-fan-big" page-id="space-follower-following">
                        <div class="tab-nav tab-nav--default _box">
                            <!--<a class="tab-nav__item " href="<?/*=site_url('space/following')*/?>">
                                我的关注
                            </a>-->
                                    ...
                                    <div class="newFanBox hover-show">
                                        <header style="background-color: #F8F3F3">
                                            <a class="_avatar _avatar--user" href="#">
                                                <img src="<?=base_url('public/uploads/'.$fan['addr'])?>">
                                            </a>
                                            <div class="ovf pt16">
                                            ...
                                            <a  class="delete js-fanboxRemoveFollow newFanBox__rm minor hover-show__item"
                                               href="#" data-uid="<?=$fan['uid']?>">删除用户</a>
                                            <a href="#" class="delete i-followedBtn newFanBox__follow" data-uid="<?=$fan['uid']?>"></a>
                                        </header>
